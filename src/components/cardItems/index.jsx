...
function CardItems({ result }) {
    if(result){
        return result.map((item) => {
            return (
              <NavLink style={{textDecoration:"none"}} key={item.id} to={`/${item.id}`} className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4 position-relative text-dark">
